...
import { StyledSection, StyledInput, Panel, Input, PriceTitle, Price, StyledButton, ProductSwiper} from "./styled";
...
export default function Buy({ product }) {
  ...
  const selectProducts = selectProductIds.map((id) => product.find((product)=>product.id ===id))
    ...
    <>
      <StyledSection as="form">
          ...
          <ProductSwiper
            ...
            direction="vertical"
            slidesPerView="auto"
            scrollbar={{ draggable: true }}ProductSwiper
            mousewheel
            pagination={{
              type: "fraction"
            }}
